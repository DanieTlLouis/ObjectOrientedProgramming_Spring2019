...
StandardCardVirtualTable::StandardCardVirtualTable() {
  // Overrides of the base table.
  print_fn = StandardCard::do_print;
  color_fn = StandardCard::do_get_color;
}

JokerCardVirtualTable::JokerCardVirtualTable() {
  // Overrides of the base table.
  print_fn = JokerCard::do_print;
  color_fn = JokerCard::do_get_color;
}

CardVirtualTable card_vtbl;
StandardCardVirtualTable standard_card_vtbl;
JokerCardVirtualTable joker_card_vtbl;
...
void
StandardCard::do_print(Card const* c, std::ostream& os)
{
  os << *static_cast<StandardCard const*>(c);
}

void 
JokerCard::do_print(Card const* c, std::ostream& os)
{
